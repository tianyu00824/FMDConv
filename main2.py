...
# Datasets
parser.add_argument('-d', '--data', default='/home/tianyu/Downloads/imagenet', type=str)
...
def main():
    ...
    # trainset = torchvision.datasets.CIFAR100(root='./train', train=True, download=True,
    ...
    #                                            drop_last=False)
    #
    # val_dataset = torchvision.datasets.CIFAR100(root='./val', train=False, download=True,
    #     transform=transforms.Compose([
    #         transforms.Resize(256),
    #         transforms.CenterCrop(224),
    #         transforms.ToTensor(),
