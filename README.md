...
python -m torch.distributed.launch --nproc_per_node=1 main.py --arch od_resnet18 --epochs 100 --lr 0.0625 --wd 1e-4 --lr-decay schedule --schedule 30 60 90 --kernel_num 8 --data /root/autodl-tmp/imagenet --dropout 0.1 --train-batch 32
