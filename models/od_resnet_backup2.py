...
class conv_basic_dy(nn.Module):
    def __init__(self, inplanes, planes, kernel_size, stride, padding, dilation = 1, groups = 1, reduction = 0.0625, kernel_num = 4):
        ...
        #print("bn1: " + str(self.bn1), " bn2: "+str(self.bn2))
        ...
        #self.attention = Attention(inplanes, planes, kernel_size, groups=groups,
        #                           reduction=reduction, kernel_num=kernel_num)
